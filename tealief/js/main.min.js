...
$(function(){function e(){var e=$("footer").height();$(".site-wrapper").css("padding-bottom",e),$("footer").css("margin-top",-e)}var n=$("html"),o=$(window),a=$(".hamburger"),i=$(".close-referer");if(window.matchMedia){var t=window.matchMedia("only screen and (-moz-min-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6/2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen  and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx)");t&&t.matches&&(document.documentElement.className+=" retina")}o.on("load",function(){n.addClass("loaded")}),a.click(function(e){e.preventDefault(),n.toggleClass("js-nav-open")}),i.click(function(e){e.preventDefault(),n.addClass("js-referer-closed")});var l=$(".js-slider");l.flickity({cellAlign:"left",contain:!0,autoPlay:4500,pageDots:!0,prevNextButtons:!0,imagesLoaded:!0}),o.on("load resize",e),$(".venobox").venobox(),navigator.userAgent.match("MSIE 10.0;")&&$("html").addClass("ie10"),Object.hasOwnProperty.call(window,"ActiveXObject")&&!window.ActiveXObject&&$("html").addClass("ie11")});