...
<?php 
	$subtitle = get_field('site_subtitle', 2);
	$posts = get_field('featured_products', 2);
	$mission_title = get_field('mission_statement_title', 2);
	$mission_copy = get_field('mission_statement_copy', 2);
	$instagram = get_field('instagram_feed', 2);
?>
<?php get_header(); ?>
	<div class="hero">
		<div class="hero-container">
			...
			<?php if( have_rows('feature_slides', 2) ): ?>
			<div class="feature-slider js-slider">

				<?php while( have_rows('feature_slides', 2) ): the_row(); 
		...
		<div class="wrapper">
			<div class="container">
				<div class="home-cta-group">
					<?php if( have_rows('call_to_action_area_1', 2) ): ?>
						<?php while( have_rows('call_to_action_area_1', 2) ): the_row(); 
					...
					<div class="home-cta-rows">
						<?php if( have_rows('call_to_action_area_2', 2) ): ?>
							<?php while( have_rows('call_to_action_area_2', 2) ): the_row(); 
							...
							<?php endwhile; ?>
						<?php endif; ?>
						<?php if( have_rows('call_to_action_area_3', 2) ): ?>
							<?php while( have_rows('call_to_action_area_3', 2) ): the_row(); 
								$image = get_sub_field('cta_icon');
								$cta_title = get_sub_field('cta_title');
								$cta_copy = get_sub_field('cta_copy');
							?>
				...
				<div class="home-cta-group">
					<div class="home-cta-rows">
						<?php if( have_rows('call_to_action_area_4', 2) ): ?>
							<?php while( have_rows('call_to_action_area_4', 2) ): the_row(); 
								$image = get_sub_field('cta_icon');
								$cta_title = get_sub_field('cta_title');
								$cta_copy = get_sub_field('cta_copy');
							?>
					...
					<?php if( have_rows('call_to_action_area_5', 2) ): ?>
						<?php while( have_rows('call_to_action_area_5', 2) ): the_row(); 
	...
	<div class="newsletter">
		...
		<form action="https://wearekured.us17.list-manage.com/subscribe/post?u=ee6d602af178bd321df4a43c3&amp;id=3924ed8a83" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form"  target="_blank" novalidate>
